...
function pai_plugin_assets() {
    ...
    // Seu CSS à parte
    wp_enqueue_style('pai-style', plugins_url( '/assets/css/pai-style.css', __FILE__ ), [], '5.2.0');
    ...
    wp_enqueue_script('pai-script', plugins_url( '/assets/js/pai-script.js', __FILE__ ), ['vlibras-externo'], '5.2.0', true);
}
